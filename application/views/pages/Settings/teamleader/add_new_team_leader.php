					...
					<form action="#" method="post">
						...
						<div class="form-group has-feedback">
							<div id="select_box">
								...
								<select required="" id="area" class="form-control select2 select2-hidden-accessible" style="width: 100%;" name="sales_manager_id"
								 tabindex="-1" aria-hidden="true">
									<option selected="" disabled="">Sales Manager</option>
