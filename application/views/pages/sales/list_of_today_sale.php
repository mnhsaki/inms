<section class="content">
	<div class="box">
		<div class="box-header">
			<h3 class="box-title"><b>All Sales List</b></h3>
		</div>
		<!-- /.box-header -->
		<div class="box-body">
							...
							<thead>
								<tr role="row">
									<th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 100px;"
									 aria-sort="ascending" aria-label="Company: activate to sort column descending">Company</th>
									<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 65px;"
									...
									<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 58px;"
									 aria-label="Sales Date: activate to sort column ascending">Sales Date</th>
							...
							<tbody>
								<tr role="row" class="odd">
									...
									<td style="color:red;" nowrap="">
										Processing. </td>
									<td nowrap="">
										<a style="margin-right: 5px;" href="#" class="btn btn-success btn-xs pull-left"><i
											 class="fa fa-share"></i>&nbsp;&nbsp;View</a>

										<a style="margin-right: 5px;" href="#" onclick="return confirm('Are You sure, Your want to Cancel This!')"
										 class="btn btn-primary btn-xs pull-left"><i class="fa fa-remove"></i>&nbsp;&nbsp;Cancel</a>
										 <a style="margin-right: 5px;" href="#" class="btn btn-success btn-xs pull-left"><i
											 class="fa fa-share"></i>&nbsp;&nbsp;Approved</a>
									</td>
								</tr>
								<tr role="row" class="even">
									<td class="sorting_1">Shikdar & Sons</td>
									<td nowrap="">SS-2515305</td>
									<td>Customer 1</td>
									<td>2018-05-12</td>
									<td>Brack Bank</td>
									<td>150</td>
									...
									<td nowrap="">
										...
										<a style="margin-right: 5px;" href="#" class="btn  btn-xs btn-default pull-left"><i
											 class="fa fa-edit"></i>&nbsp;&nbsp;Edit</a>
										<a href="#" onclick="return confirm('Are You sure, Your want to delete This!')"
										 class="btn btn-danger btn-xs pull-left"><i class="fa fa-trash"></i>&nbsp;&nbsp;Delete</a>
									</td>
								</tr>
								<tr role="row" class="odd">
									<td class="sorting_1">Shikdar & Sons</td>
									<td nowrap="">SS-9960734</td>
									<td>Customer 1</td>
									<td>2018-04-09</td>
									<td>bKash</td>
									<td>2100</td>
