						...
						<div class="row">
							...
							<div class="col-sm-5" >
								<div id="" class="dataTables_filter"><label>Search:<input type="search" class="form-control input-sm"
										 placeholder="Brand Name" aria-controls="example1"></label></div>
                            </div>
                            <div class="col-xs-1">
                                <a href="add_new_Brand"><button type="submit" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;New Brand</button></a>
                            </div>
						</div>
						<div class="row">
							<div class="col-sm-12">
								<table id="" class="table table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example1_info">
									<thead>
										<tr role="row">
											...
											<th style="width: 290px;" class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
											 aria-label="Product Name: activate to sort column ascending">Brand Name</th>
									...
									<tbody>
										<tr role="row" class="odd">
                                            ...
                                            <td><a href="#" onclick="" data-toggle="modal" data-target="">Brand</a></td>
											<td>
